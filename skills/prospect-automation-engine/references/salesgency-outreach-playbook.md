...
- `automating [Company]'s prospecting`
- `quick q re: [Company] outbound`
...
[Your Name]
SalesGency · hello@salesgency.com
```
...
• n8n Build Prompt to generate custom GTM workflows from scratch

If you're already using n8n or building agentic workflows, this gives you a massive head start.

Happy to send more details or a sample. Worth a quick look?
...
One client used it to rebuild their entire outreach automation in an afternoon.

If that's useful for what you're building, I'm happy to walk through it on a quick call or drop you the docs.
...
- `always-on pipeline for [Company]`
...
We built it for founders and sales leaders who want to scale pipeline without scaling headcount.

Would it be worth 20 minutes to see if it fits [Company]'s motion?
...
One question I get a lot: "How is this different from just using Clay or Apollo?"

The difference is the full-stack automation. Those tools give you data. The Custom Agent gives you:
→ ICP discovery (no list to build)
→ Company + contact research
→ AI-written, personalized PAS emails
→ Sequence enrollment
→ CRM updates

All connected. All running automatically.

Happy to show you a live demo. 20 minutes?
...
Is automating prospecting something on your radar for [Company] in Q[X]?
```
...
Happy to share a one-pager or jump on a quick call if it's even slightly relevant. No pressure either way.
```
...
Use these for A/B testing across any sequence:

**Curiosity / Question:**
- `quick q re: [Company] pipeline`
- `how [Company] could automate outbound`
- `what's [Company]'s prospecting process look like?`

**Direct / Value:**
- `automating [Company]'s lead gen`
- `n8n GTM automation for [Company]`
- `prospect automation · delivered in 7 days`
...
|---|---|---|---|
| Email 1 | Day 1 | Email | First Touch |
| LI Connection | Day 2 | LinkedIn | Connection Request |
| LI Message | Day 3 | LinkedIn | After Connection |
| Email 2 | Day 5 | Email | Value Follow-Up |
| Email 3 | Day 9 | Email | Value Bump |
| LI Re-Engage | Day 11 | LinkedIn | Re-Engagement |
| Email 4 | Day 14 | Email | Break-Up |

> **Pro tip:** Use the PAE itself to run this sequence automatically. The Custom Engagement can be configured to trigger on any prospect trigger and run all 7 touches across email and LinkedIn with personalized copy.

---

*SalesGency · PAE Outreach Playbook · v1.0 · September 2026*  
*Internal Use Only*
